        ...
        children: [
          ...
          Container(
            ...
            child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Row(children: [
              ...
              Responsive.isTablet(context) ? SizedBox():
              SizedBox(
                width: 500,
                child: AddressHelper.getAddressFromSharedPref() != null ? InkWell(
                  onTap: () => Get.find<SplashController>().navigateToLocationScreen('home'),
              ...
              Expanded(child: CustomTextFieldWidget(hintText: "Search",readtrue: true,tap: () => Get.toNamed(RouteHelper.getSearchRoute()),)),
      
              // MenuIconButton(icon: CupertinoIcons.search, onTap: () => Get.toNamed(RouteHelper.getSearchRoute())),
               SizedBox(width:Responsive.isTablet(context) ?0: 20),
      
              Responsive.isTablet(context) ? const SizedBox():MenuIconButton(icon: CupertinoIcons.bell_fill, onTap: () => Get.toNamed(RouteHelper.getNotificationRoute())),
               SizedBox(width: Responsive.isTablet(context) ?0:10),
      
              Responsive.isTablet(context) ? const SizedBox(): MenuIconButton(icon: Icons.shopping_cart, isCart: true, onTap: () => Get.toNamed(RouteHelper.getCartRoute())),
               SizedBox(width:Responsive.isTablet(context) ?0: 10),
